...
<div class="w-full mx-auto text-center">
    ...
    <div class="mx-auto mb-20 max-w-7xl">
        ...
        <div class="flex flex-col md:flex-row justify-center py-5 border-b border-gray-200">
            <div class="w-48 h-64 overflow-hidden aspect-w-3 aspect-h-4 mb-4 md:mb-0">
                <img src="{{ asset('images/' . $cartItem->book->image_path) }}" alt="{{ $cartItem->book->bookName }}" class="w-full h-full object-cover">
            </div>
            <div class="flex-grow ml-8 text-center md:text-left">
            ...
            <div class="mt-4 flex flex-col md:flex-row items-center justify-center md:space-x-4">
